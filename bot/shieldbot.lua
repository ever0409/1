...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {60018416,142141024,232006008,195801672,259448439,239832443,198794027},--Sudo users
    moderation = {data = 'data/moderation.json'},
    about_text = [[ℹ️About #PowerupPlus Teamℹ️
▶️Team #Member◀️
1= @Mr_Nitro [Dev]
2 = @XHACKERX [Dev]
3 = @Navid_Quick [Dev]
4 = @This_Is_Pouria [Dev]
5 = @SeedPower [Bot Number And Editor]
6 = @Mrhackers [Bot Server And Sudo]
🆔Power➕ = @PowerupPlus
🆔Channel Power Team : @PowerupTG_CH]],
    help_text_realm = [[
Realm Commands:
!creategroup [Name]
Create a group
